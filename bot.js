...
const PRICES = {
    ...
    "1т Аккерманн 500": 48500,
    "1т Аккерманн 600": 50000,
    "наружный краска": 800,
...
bot.hears("Цемент", (ctx) => {
    ...
    ctx.reply(
        ...
        Markup.keyboard([
            ...
            ["1т Аккерманн 500 - 48500 тг"],
            ["1т Аккерманн 600 - 50000 тг"]
        ]).resize()
    )
})
...
bot.hears([
    ...
    if (text === "1т Аккерманн 500 - 48500 тг")
        product = "1т Аккерманн 500"

    if (text === "1т Аккерманн 600 - 50000 тг")
        product = "1т Аккерманн 600"
